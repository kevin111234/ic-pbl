...
def customer_onlinesales(sql_pswd):
...
def rate_discount(sql_pswd):
    ...
    # 마케팅정보 판매정보 결합
def marketing_onlinesales(sql_pswd):
    ...
    # 고객정보 판매정보 결합
def customer_onlinesales_all(sql_pswd):
